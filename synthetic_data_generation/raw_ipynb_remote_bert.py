...
Original file is located at
    https://colab.research.google.com/github/ratmcu/wikipiifed/blob/master/remote_bert.ipynb
...
import sys
# !pip install syft
!git clone "https://github.com/ratmcu/PySyft.git"
...
#run the above cell and restart the runtime then run below
...
utility class for managing dataset and padding functions
"""
